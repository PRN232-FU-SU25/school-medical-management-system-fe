...
import { useDeleteDocument } from '@/queries/document.query';
import { toast } from '@/components/ui/use-toast';
import AuditTrailTableDialog from '../contract-dialog/audit-trail-table-dialog';
import { useGetAllContractDocumentHistory } from '@/queries/history.query';
    ...
    <>
      ...
      >
        <DialogContent className="max-h-[90%] max-w-[80%] overflow-y-auto bg-white 2xl:max-w-[70%]">
          ...
          <AuditTrailTableDialog
            itemId={data.id}
            useGetHistory={useGetAllContractDocumentHistory}
          />
        </DialogContent>
      </Dialog>
      ...
      >
        <DialogContent className="max-h-[90%] max-w-[80%] overflow-y-auto bg-white 2xl:max-w-[70%]">
          ...
          <DocumentDialog type="view" document={data} />
        </DialogContent>
      </Dialog>
